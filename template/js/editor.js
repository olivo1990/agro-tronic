	...
	var methods = {
		...
		init : function( options )
		{
			...
			var menuItems = { 'fonteffects': true,
							  ...
							  'styles'	: { "select":true,
											"default": "Formato",
											"tooltip": "Formato parrafo",
											"commandname": "formatBlock",
											"custom":null },

							 'font_size': {	"select":true,
											"default": "Tamaño",
											"tooltip": "Tamaño letra",
							  ...
							  'color'	: { "text":"A",
											...
											"custom":function(button){
													var editor = $(this);
													var flag = 0;
													var paletteCntr   = $('<div/>',{id:"paletteCntr",class:"activeColour", css :{"display":"none","width":"auto"}}).click(function(event){event.stopPropagation();});
													var paletteDiv    = $('<div/>',{id:"colorpellete"});
													var palette       = $('<ul />',{id:"color_ui"}).append($('<li />').css({"width":"145px","display":"Block","height":"25px"}).html('<div>Color del texto</div>'));
													var bgPalletteDiv = $('<div/>',{id:"bg_colorpellete"});
													//var bgPallette    = $('<ul />',{id:"bgcolor_ui"}).append($('<li />').css({"width":"145px","display":"Block","height":"25px"}).html('<div>Color del fondo</div>'));
			...
			var $this = $(this).hide();	       	
	       	...
	       	var editor  = $( "<div/>",{	class : "Editor-editor form-control",
										css : {overflow: "auto"},
